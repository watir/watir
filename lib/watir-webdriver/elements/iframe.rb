module Watir
  class IFrame < HTMLElement
    ...
    def locate
      ...
      locator = locator_class.new(@parent.wd, @selector.merge(tag_name: frame_tag), self.class.attribute_list, element_validator_class, selector_builder_class, finder_class)
