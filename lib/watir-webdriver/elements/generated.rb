...
module Watir
  ...
  class Object < HTMLElement
    ...
    attributes(:html_element => ([:form]), :document => ([:content_document]), :string => ([:data, :type, :name, :use_map, :width, :height, :content_window, :validity, :validation_message]), :bool => ([:will_validate]))
  end
  ...
  class Media < HTMLElement
    attributes(:string => ([:error, :src, :current_src, :preload, :buffered, :played, :seekable]), :bool => ([:seeking, :paused, :ended, :autoplay, :loop, :controls, :muted]), :float => ([:current_time, :start_time, :duration, :default_playback_rate, :playback_rate, :volume]), :int => ([:network_state, :ready_state]))
  end
  ...
  class Table < HTMLElement
    ...
    attributes(:html_element => ([:caption, :t_head, :t_foot]), :string => ([:summary]), :html_collection => ([:t_bodies, :rows]))
  end
  ...
  class FieldSet < HTMLElement
    ...
    attributes(:html_element => ([:form]), :string => ([:name, :type, :validity, :validation_message]), :html_collection => ([:elements]), :bool => ([:disabled, :will_validate]))
  end
  ...
  class Button < HTMLElement
    ...
    attributes(:html_element => ([:form]), :string => ([:form_action, :form_enctype, :form_method, :form_no_validate, :form_target, :name, :type, :value, :validity, :validation_message]), :bool => ([:autofocus, :disabled, :will_validate]), :list => ([:labels]))
  end
  ...
  class Select < HTMLElement
    ...
    attributes(:html_element => ([:form]), :string => ([:name, :type, :value, :validity, :validation_message]), :html_collection => ([:options, :selected_options]), :bool => ([:autofocus, :disabled, :multiple, :will_validate]), :int => ([:size, :length, :selected_index]), :list => ([:labels]))
  end
  ...
  class Option < HTMLElement
    ...
    attributes(:html_element => ([:form]), :string => ([:label, :value, :text]), :bool => ([:disabled, :default_selected, :selected]), :int => ([:index]))
  end
  ...
  class TextArea < HTMLElement
    ...
    attributes(:html_element => ([:form]), :string => ([:name, :placeholder, :wrap, :type, :default_value, :value, :validity, :validation_message]), :bool => ([:autofocus, :disabled, :read_only, :required, :will_validate]), :int => ([:cols, :max_length, :rows, :text_length, :selection_start, :selection_end]), :list => ([:labels]))
  end
  ...
  class Keygen < HTMLElement
    ...
    attributes(:html_element => ([:form]), :string => ([:challenge, :keytype, :name, :type, :validity, :validation_message]), :bool => ([:autofocus, :disabled, :will_validate]), :list => ([:labels]))
  end
  ...
  class Output < HTMLElement
    ...
    attributes(:html_element => ([:form]), :string => ([:name, :type, :default_value, :value, :validity, :validation_message]), :bool => ([:will_validate]), :list => ([:labels]), :token_list => ([:html_for]))
  end
