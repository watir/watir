...
module Watir
  ...
  class Marquee < HTMLElement
    ...
    attribute(Interger, :hspace, :hspace)
    attribute(Interger, :loop, :loop)
    attribute(Interger, :scroll_amount, :scrollAmount)
    attribute(Interger, :scroll_delay, :scrollDelay)
    attribute("Boolean", :true_speed?, :trueSpeed)
    attribute(Interger, :vspace, :vspace)
  ...
  class TextArea < HTMLElement
    ...
    attribute("Boolean", :autofocus?, :autofocus)
    attribute(Interger, :cols, :cols)
    attribute(String, :dir_name, :dirName)
    attribute("Boolean", :disabled?, :disabled)
    attribute(String, :form, :form)
    attribute(String, :input_mode, :inputMode)
    attribute(Interger, :max_length, :maxLength)
    attribute(Interger, :min_length, :minLength)
    attribute(String, :name, :name)
    ...
    attribute(String, :validation_message, :validationMessage)
    attribute(String, :labels, :labels)
    attribute(Interger, :selection_start, :selectionStart)
    attribute(Interger, :selection_end, :selectionEnd)
  ...
  class Option < HTMLElement
    ...
    attribute(String, :value, :value)
    attribute(Interger, :index, :index)
  end
  ...
  class Select < HTMLElement
    ...
    attribute(String, :name, :name)
    attribute("Boolean", :required?, :required)
    attribute(Interger, :size, :size)
    attribute(String, :type, :type)
    attribute(String, :options, :options)
    attribute(Interger, :length, :length)
    attribute(String, :selected_options, :selectedOptions)
    attribute(Interger, :selected_index, :selectedIndex)
    attribute(String, :value, :value)
    attribute("Boolean", :will_validate?, :willValidate)
    attribute(String, :validity, :validity)
    attribute(String, :validation_message, :validationMessage)
  ...
  class TableCell < HTMLElement
    attribute(Interger, :col_span, :colSpan)
    attribute(Interger, :row_span, :rowSpan)
    attribute(String, :headers, :headers)
    attribute(Interger, :cell_index, :cellIndex)
    attribute(String, :align, :align)
  ...
  class TableRow < HTMLElement
    attribute(Interger, :row_index, :rowIndex)
    attribute(Interger, :section_row_index, :sectionRowIndex)
    attribute(String, :align, :align)
    attribute(String, :ch, :ch)
    attribute(String, :ch_off, :chOff)
    attribute(String, :v_align, :vAlign)
  ...
  class Media < HTMLElement
    ...
    attribute(String, :cross_origin, :crossOrigin)
    attribute(Interger, :network_state, :networkState)
    attribute(String, :preload, :preload)
    attribute(String, :buffered, :buffered)
    attribute(Interger, :ready_state, :readyState)
  ...
  class Video < Media
    attribute(Interger, :width, :width)
    attribute(Interger, :height, :height)
    attribute(Interger, :video_width, :videoWidth)
    attribute(Interger, :video_height, :videoHeight)
  ...
  class Image < HTMLElement
    ...
    attribute(Interger, :width, :width)
    attribute(Interger, :height, :height)
    attribute(Interger, :natural_width, :naturalWidth)
    attribute(Interger, :natural_height, :naturalHeight)
  ...
  class LI < HTMLElement
    attribute(Interger, :value, :value)
    attribute(String, :type, :type)
  end
  ...
  class OList < HTMLElement
    ...
    attribute(Interger, :start, :start)
    attribute(String, :type, :type)
    attribute("Boolean", :compact?, :compact)
  end
